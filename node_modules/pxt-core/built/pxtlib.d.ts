...
declare namespace pxt.analytics {
     ...
     */
    function consentWrapper<T>(that: T): (cb: () => void) => () => void;
}
...
declare namespace ts.pxtc {
    ...
    var encodeBase64: (s: string) => string;
}
declare namespace ts.pxtc.Util {
    ...
    var translationDb: ITranslationDb;
    /**
    ...
    function updateLocalizationAsync(targetId: string, simulator: boolean, baseUrl: string, code: string, pxtBranch: string, targetBranch: string, live?: boolean): Promise<void>;
...
declare namespace pxt {
     ...
     * Track an event.
     */
    var tickEvent: (id: string, data?: Map<string | number>, opts?: TelemetryEventOptions) => void;
    /**
...
declare namespace pxt.crowdin {
     ...
     */
    function listFilesAsync(branch: string, prj: string, key: string, crowdinPath: string): Promise<{
        fullName: string;
    }[]>;
}
