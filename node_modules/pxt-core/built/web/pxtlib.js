...
(function (pxt) {
    ...
    (function (analytics) {
        ...
        analytics.consentWrapper = consentWrapper;
        ...
        (function (Util) {
            ...
            function updateLocalizationAsync(targetId, simulator, baseUrl, code, pxtBranch, targetBranch, live) {
                ...
                function mergeTranslations(tr) {
                    ...
                    Object.keys(tr)
                        ...
                        .forEach(function (k) { return _localizeStrings[k] = tr[k]; });
                }
                var hadError = false;
                var pAll = Promise.mapSeries(stringFiles, function (file) {
            ...
            function toDataUri(data, mimetype) {
                ...
                if (/xml|svg/.test(mimetype))
                    ...
                    return "data:" + (mimetype || "image/png") + ";base64," + ts.pxtc.encodeBase64(toUTF8(data));
            }
