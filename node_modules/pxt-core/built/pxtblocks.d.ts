...
declare namespace pxtblockly {
    class FieldParameter extends Blockly.FieldTextInput {
        currentName: string;
        defaultName: string;
        restrictedNames: string[];
        constructor(initialName: string, defaultName: string, restrictedNames: string[]);
        init(b?: Blockly.Block): void;
        showEditor_(): void;
        renameDialog(variable: Blockly.VariableModel): void;
        private getOrCreateVariable();
        private isRestrictedName(name);
    }
}
declare namespace pxtblockly {
